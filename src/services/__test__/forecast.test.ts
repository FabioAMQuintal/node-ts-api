...
import { Beach, BeachPosition } from '@src/interfaces/beach';
...
describe('forecast service', () => {
  ...
  it('should throw internal processing error when somethiung goes wrong during the rating process', async () => {
    const beaches: Beach[] = [{
      lat: -33.792726,
      lng: 151.289824,
      name: 'Manly',
